...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		sensitiveMonitorRoute.Use(middleware.AdminAuth())
		{
			...
			sensitiveMonitorRoute.GET("/hits/export", controller.ExportSensitiveMonitorHits)
			sensitiveMonitorRoute.POST("/hits/:id/false_positive", controller.MarkSensitiveMonitorHitFalsePositive)
